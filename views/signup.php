...
<form method="POST" action="user-register">
    ...
    <img class="mb-4 mx-auto d-block rounded-circle shadow " src="/assets/images/logo.webp" alt="" width="72" height="57">
    <h1 class="h3 mb-3 fw-normal text-center">Create account</h1>

    <div class="form-floating mb-2 ">
      <input type="text" name="username" placeholder="Name" required class="form-control " id="floatingInput" >
      <label class="text-center" for="floatingInput ">User Name</label>
    </div>
    <div class="form-floating ">
      <input type="email" name="email" placeholder="Email" required class="form-control "  >
      <label class="text-center" for="floatingInput ">Email address</label>
      <?php if (!empty($error)): ?>
    ...
    <!-- <div class="form-floating">
      <input name="repassword" type="password" class="form-control" id="floatingPassword" placeholder="Retype Password">
